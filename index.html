...
<html>
    ...
    <body>
                    ...
                    <div id="navbarcollapse" class="navbar-collapse collapse">
                        ...
                        <div class="dropdown float-sm-end">
                            <a href="#" class="dropdown-toggle text-decoration-none" data-bs-toggle="dropdown">
                                <img src="./assets/img/users/user1.jpg" alt="user1" class="rounded-circle" width="32px" height="32px"/>
                            </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="cards mb-3">
                        <img src="./assets/img/users/user1.jpg" alt="user1"/>
                        <h4>Ms.July</h4>
                    ...
                    <div class="cards mb-3">
                        <img src="./assets/img/users/user2.jpg" alt="user2"/>
                        <h4>Ms.Anton</h4>
                    ...
                    <div class="cards mb-3">
                        <img src="./assets/img/users/user3.jpg" alt="user3"/>
                        <h4>Ms.Honey</h4>
                    ...
                    <div class="cards mb-3">
                        <img src="./assets/img/users/team_popup.jpg" alt="user4"/>
                        <h4>Ms.Thida</h4>
            ...
            <div class="container-fluid">
                <div class="d-flex flex-wrap justify-content-center">
                    <div class="filters room">
                        <img src="./assets/img/gallery/image1.jpg" alt="image1" width="200px"/>
                    </div>

                    <div class="filters room">
                        <img src="./assets/img/gallery/image2.jpg" alt="image2" width="200px"/>
                    </div>

                    <div class="filters room">
                        <img src="./assets/img/gallery/image3.jpg" alt="image3" width="200px"/>
                    </div>

                    <div class="filters decoration">
                        <img src="./assets/img/gallery/image4.jpg" alt="image4" width="200px"/>
                    </div>

                    <div class="filters decoration">
                        <img src="./assets/img/gallery/image5.jpg" alt="image5" width="200px"/>
                    </div>

                    <div class="filters decoration">
                        <img src="./assets/img/gallery/image6.jpg" alt="image6" width="200px"/>
                    </div>

                    <div class="filters furniture">
                        <img src="./assets/img/gallery/image7.jpg" alt="image7" width="200px"/>
                    </div>

                    <div class="filters furniture">
                        <img src="./assets/img/gallery/image8.jpg" alt="image8" width="200px"/>
                    </div>

                    <div class="filters furniture">
                        <img src="./assets/img/gallery/image9.jpg" alt="image9" width="200px"/>
                    </div>
        ...
        <!-- magnific popup css1 js1 -->
        <script src="./assets/libs/magnific-popup-master/dist/jquery.magnific-popup.min.js" type="text/javascript"></script>
        <!-- custom js -->
